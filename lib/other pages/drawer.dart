...
class drawers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Drawer(
      ...
      const UserAccountsDrawerHeader(decoration: BoxDecoration(
  ...
  const Divider(color: Colors.white,thickness: 1),
    const ListTile(
      ...
      title: Text("Home",style: TextStyle(fontSize: 19,color: Colors.white),),
        ...
        InkWell(onTap:()=> Navigator.push(context, MaterialPageRoute(builder:(context) => version())),
        ...
        const Covid(),)),
            child: const ListTile(title: Text("Covid-19",style: TextStyle(color: Colors.white,fontSize: 19),),)
        ),
        InkWell(onTap:()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>
        const about(),)),
            child: const ListTile(title: Text("About",style: TextStyle(color: Colors.white,fontSize: 19),),)
        ),
    ]),
    );
  }
